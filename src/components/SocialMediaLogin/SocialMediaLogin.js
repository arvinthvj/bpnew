    ...
    return (
        <FacebookLogin
            ...
            render={renderProps => {
                ...
                return (
                    <a href="javascript:void(0)" onClick={onClickFBLogin} className="icn_fa icn_fa_fb">
                        <img src="images/icons/icn_fb.png" alt="FACEBOOK" />
                        {props.socialMediaFBText}
                    </a>
                )
            }}
        />
    ...
    return (
        <GoogleLogin
            ...
            render={(renderProps) => {
                ...
                return (
                    <a href="javascript:void(0)" onClick={onClickGoogleLogin} className="icn_fa icn_fa_gogle">
                        <img src="images/icons/icn_google.png" alt="GOOGLE" />
                        {props.socialMediaGoogleText}
                    </a>
                )
            }}
            // buttonText="Login"
