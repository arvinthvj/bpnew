...
const cancelRegistrationModal = props => {
    return (
        <div className="modal fade" id="cancel_registration_form" tabIndex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div className="modal-content">
                    <div className="modal-body text-center">
                        ...
                        <p className="mb-3">If you abort registration now, no account will be created and you will need to start over again.</p>
                        <div className="d-flex justify-content-center">
                            <a onClick={() => { props.history.push(routes.HOME) }} data-dismiss="modal" href="javascript:void(0)" className="form_link ft_Weight_500 ph_underline">[Abort Now]</a>
