...
const MyServices = (props) => {
    ...
    const addCategoryId = (myService, categories) => {
        ...
        categories.forEach(categorie => {
            if (categorie.name === Categories.MY_SERVICES) {
    ...
    const addOrUpdateMyService = (values) => {
        ...
        const a = myService.compensation_ids;
        const set = new Set([a]);
    ...
    return (
        ...
        >
            {(formicProps) => {
                ...
                console.log(formicProps.values, "formicProps")
                return (
                    <Form>
                        {!isSafari() && < Prompt
                        ...
                        <div className="card switch_card_list card_bg_300" id="add_new_service">
                            <div className="card-body">
                                ...
                                <div className="form_group_modify">
                                    <label for="ServiceDescription" className="label_modify">Description/Type/Timeframe <span className="text-danger">*</span></label>
