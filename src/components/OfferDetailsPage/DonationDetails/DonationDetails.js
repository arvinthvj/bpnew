...
import { Banner, ProfileSection, MorePhotosBlock, CompensationSection, DescriptionSection } from '../OfferDetailsPage/OfferDetailsPage'
...
const donationDetails = props => {
    ...
    if (props.details && !props.isServiceLoading) {
        ...
        console.log(props.details, "donationDetailsXYZ")
        content = (
            <Oux>
                <Banner
                ...
                <div className="container-fluid theme_px_150">
                    <ProfileSection setImagePreviewToEmpty={props.setImagePreviewToEmpty} user={props.user} history={props.history} detailsId={props.details.id} profile={props.details.profile} updateConversationReceiver={props.updateConversationReceiver} />
                            ...
                            props.details.website
                                ? <div className="ht_detail_inner">
                                    <div className="row">
                                        <div className="col-xl-4 col-lg-5">
                                            <article className="right_content">
                                                <h2 className="ft_Weight_600">URL</h2>
                                            </article>
                                        </div>
                                        <div className="col-xl-8 col-lg-7">
                                            <div className="left-content">
                                                <ul className="ul_list">
                                                    <li className="list_items ex_list">
                                                        <a href={props.details.website.includes('http') || props.details.website.includes('https') ? props.details.website : `https://${props.details.website}`} target="_blank" className="ph_underline">{props.details.website}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        ? <div className="container-fluid captured_photos_right">
                            <div className="ht_theme_details">
                                <div className="ht_detail_inner captured_photos">
                                    <MorePhotosBlock imagePreview={props.imagePreview} heading="Portfolio" attachments={props.details.attachments} />
                                </div>
                            </div>
                        </div>
                        : null
