        ...
        content = (
            <Oux>
                ...
                <div className="container-fluid theme_px_150">
                    <ProfileSection setImagePreviewToEmpty={props.setImagePreviewToEmpty} history={props.history} detailsId={props.details.id} user={props.user} profile={props.details.profile} updateConversationReceiver={props.updateConversationReceiver} />
                    ...
                    <div className="ht_theme_details">
                        {
                            props.details.description
                                ? <DescriptionSection title={props.details.title} storeFullDescription={props.storeFullDescription} heading="Place Description" description={props.details.description} />
                                : null
                        }
                        {
                            ...
                            props.details.specification
                                ? <div className="ht_detail_inner">
                                    <div className="row">
                                        <div className="col-xl-4 col-lg-5">
                                            <article className="right_content">
                                                <h2 className="ft_Weight_600">Rules & Restrictions</h2>
                                            </article>
                                        </div>
                                        <div className="col-xl-8 col-lg-7">
                                            <div className="left-content">
