        ...
        content = (
            <Oux>
                ...
                <div className="container-fluid theme_px_150">
                    <ProfileSection setImagePreviewToEmpty={props.setImagePreviewToEmpty} user={props.user} detailsId={props.details.id} history={props.history} profile={props.details.profile} updateConversationReceiver={props.updateConversationReceiver} />
                    <SkillSection skills={props.details.skills} user={props.user} />
                    ...
                    <div className="ht_theme_details">
                        {
                            props.details.description
                                ? <DescriptionSection storeFullDescription={props.storeFullDescription} title={props.details.title} description={props.details.description} />
                                : null
                        }
                        {
                                            ...
                                            <div className="left-content">
                                                <ul className="ul_list">
                                                    <li className="list_items ex_list">
                                                        <p className="com_info"><span className="first_letter_capital">{props.details.specification}</span></p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
