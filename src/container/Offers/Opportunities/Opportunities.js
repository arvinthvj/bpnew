...
import OpportunitiesComponent from "../../../components/OpportunitiesForm/OpportunitesForm";
...
class Opportunities extends Component {
  constructor(props) {
    ...
    // this.editOpportunitiesClicked = this.editOpportunitiesClicked.bind(this);
    // this.cancelOpportunitiesClicked = this.cancelOpportunitiesClicked.bind(this);
  }
  ...
  componentDidMount = () => {
    ...
    if (isEdit && service) {
      this.editOpportunitiesClicked(storage.get("service", null));
      this.props.getOpportunitiesList(
  ...
  editOpportunitiesClicked = (Service) => {
    this.setState({
      showOpportunities: true,
      service: Service,
    });
  ...
  addOrUpdateOpportunities = (Opportunities) => {
    ...
    if (
      ...
      if (Opportunities.address) {
        delete Opportunities.address.id;
        delete Opportunities.address.state_code;
      }
      Opportunities["delete_attachment_ids"] = this.state.idsToDelete;
      ...
      } else if (Opportunities.profilePicPath) {
        let photo_paths = [];
        photo_paths.push(Opportunities.profilePicPath);
        Opportunities["new_photo_paths"] = photo_paths;
        delete Opportunities.profilePicPath;
        this.props.updateOpportunitiesService(
          this.state.service.id,
          Opportunities
        );
      } else {
      ...
      if (this.state.base64 && this.state.base64.length > 0) {
        ...
        let photo_paths = [];
        photo_paths.push(Opportunities.profilePicPath);
        Opportunities["photo_paths"] = photo_paths;
        delete Opportunities.profilePicPath;
        this.props.addOpportunitiesService(Opportunities);
      } else {
        // this.props.addOpportunitiesService(Opportunities);
            ...
            <div className="ph_flex_wrp_spw ph_switch_wrp align-items-start">
              ...
              <div className="ph_switch_con ph_crud_wrp">
                ...
                <a
                  ...
                  onClick={() => this.editOpportunitiesClicked(service)}
                >
      ...
      if (
          ...
          >
            ...
            >
              ...
              <div class="text-center mt-2">
                <a
                  href="javascript:void(0)"
                  onClick={this.createOpportunitiesClicked}
                  className="theme_btn theme_primary"
                >
                  CREATE NEW OFFER
                </a>
        ...
        return (
          <div
            ...
            aria-labelledby="pills-my-services-tab"
          >
            { this.props.isFormOpen || this.state.showOpportunities ? (
              <OpportunitiesComponent
                ...
                addOrUpdateOpportunities={this.addOrUpdateOpportunities}
                cancelOpportunitiesClicked={this.cancelOpportunitiesClicked}
              />
            ) : (
...
const mapDispatchToProps = (dispatch) => {
  return {
    getOpportunitiesList: (profileId, categorieId) =>
      dispatch(actions.getServicesList(profileId, categorieId)),
    addOpportunitiesService: (service) => dispatch(actions.addService(service)),
    ...
    updateOpportunitiesService: (id, service) =>
